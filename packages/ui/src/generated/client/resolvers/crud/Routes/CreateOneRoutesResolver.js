...
exports.CreateOneRoutesResolver = void 0;
...
let CreateOneRoutesResolver = class CreateOneRoutesResolver {
...
], CreateOneRoutesResolver.prototype, "createOneRoutes", null);
CreateOneRoutesResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Routes_1.Routes)
], CreateOneRoutesResolver);
exports.CreateOneRoutesResolver = CreateOneRoutesResolver;
