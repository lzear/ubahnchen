...
const actionResolversMap = {
    Calendar: {
        ...
        findFirstCalendarOrThrow: actionResolvers.FindFirstCalendarOrThrowResolver,
        calendars: actionResolvers.FindManyCalendarResolver,
        calendar: actionResolvers.FindUniqueCalendarResolver,
        getCalendar: actionResolvers.FindUniqueCalendarOrThrowResolver,
    ...
    Calendar_dates: {
        ...
        findFirstCalendar_datesOrThrow: actionResolvers.FindFirstCalendar_datesOrThrowResolver,
        ...
        findUniqueCalendar_datesOrThrow: actionResolvers.FindUniqueCalendar_datesOrThrowResolver,
    ...
    Routes: {
        ...
        findFirstRoutesOrThrow: actionResolvers.FindFirstRoutesOrThrowResolver,
        findManyRoutes: actionResolvers.FindManyRoutesResolver,
        findUniqueRoutes: actionResolvers.FindUniqueRoutesResolver,
        findUniqueRoutesOrThrow: actionResolvers.FindUniqueRoutesOrThrowResolver,
    ...
    Stop_times: {
        ...
        findFirstStop_timesOrThrow: actionResolvers.FindFirstStop_timesOrThrowResolver,
        ...
        findUniqueStop_timesOrThrow: actionResolvers.FindUniqueStop_timesOrThrowResolver,
    ...
    Stops: {
        ...
        findFirstStopsOrThrow: actionResolvers.FindFirstStopsOrThrowResolver,
        findManyStops: actionResolvers.FindManyStopsResolver,
        findUniqueStops: actionResolvers.FindUniqueStopsResolver,
        findUniqueStopsOrThrow: actionResolvers.FindUniqueStopsOrThrowResolver,
    ...
    Trips: {
        ...
        findFirstTripsOrThrow: actionResolvers.FindFirstTripsOrThrowResolver,
        findManyTrips: actionResolvers.FindManyTripsResolver,
        findUniqueTrips: actionResolvers.FindUniqueTripsResolver,
        findUniqueTripsOrThrow: actionResolvers.FindUniqueTripsOrThrowResolver,
...
const crudResolversInfo = {
    Calendar: ["aggregateCalendar", "createOneCalendar", "deleteManyCalendar", "deleteOneCalendar", "findFirstCalendar", "findFirstCalendarOrThrow", "calendars", "calendar", "getCalendar", "groupByCalendar", "updateManyCalendar", "updateOneCalendar", "upsertOneCalendar"],
    Calendar_dates: ["aggregateCalendar_dates", "createOneCalendar_dates", "deleteManyCalendar_dates", "deleteOneCalendar_dates", "findFirstCalendar_dates", "findFirstCalendar_datesOrThrow", "findManyCalendar_dates", "findUniqueCalendar_dates", "findUniqueCalendar_datesOrThrow", "groupByCalendar_dates", "updateManyCalendar_dates", "updateOneCalendar_dates", "upsertOneCalendar_dates"],
    Routes: ["aggregateRoutes", "createOneRoutes", "deleteManyRoutes", "deleteOneRoutes", "findFirstRoutes", "findFirstRoutesOrThrow", "findManyRoutes", "findUniqueRoutes", "findUniqueRoutesOrThrow", "groupByRoutes", "updateManyRoutes", "updateOneRoutes", "upsertOneRoutes"],
    Stop_times: ["aggregateStop_times", "createOneStop_times", "deleteManyStop_times", "deleteOneStop_times", "findFirstStop_times", "findFirstStop_timesOrThrow", "findManyStop_times", "findUniqueStop_times", "findUniqueStop_timesOrThrow", "groupByStop_times", "updateManyStop_times", "updateOneStop_times", "upsertOneStop_times"],
    Stops: ["aggregateStops", "createOneStops", "deleteManyStops", "deleteOneStops", "findFirstStops", "findFirstStopsOrThrow", "findManyStops", "findUniqueStops", "findUniqueStopsOrThrow", "groupByStops", "updateManyStops", "updateOneStops", "upsertOneStops"],
    Trips: ["aggregateTrips", "createOneTrips", "deleteManyTrips", "deleteOneTrips", "findFirstTrips", "findFirstTripsOrThrow", "findManyTrips", "findUniqueTrips", "findUniqueTripsOrThrow", "groupByTrips", "updateManyTrips", "updateOneTrips", "upsertOneTrips"]
};
const argsInfo = {
    ...
    FindFirstCalendarOrThrowArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    FindManyCalendarArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    FindUniqueCalendarArgs: ["where"],
    FindUniqueCalendarOrThrowArgs: ["where"],
    ...
    FindFirstCalendar_datesOrThrowArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    FindManyCalendar_datesArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    FindUniqueCalendar_datesArgs: ["where"],
    FindUniqueCalendar_datesOrThrowArgs: ["where"],
    ...
    FindFirstRoutesOrThrowArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    FindManyRoutesArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    FindUniqueRoutesArgs: ["where"],
    FindUniqueRoutesOrThrowArgs: ["where"],
    ...
    FindFirstStop_timesOrThrowArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    FindManyStop_timesArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    FindUniqueStop_timesArgs: ["where"],
    FindUniqueStop_timesOrThrowArgs: ["where"],
    ...
    FindFirstStopsOrThrowArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    FindManyStopsArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    FindUniqueStopsArgs: ["where"],
    FindUniqueStopsOrThrowArgs: ["where"],
    ...
    FindFirstTripsOrThrowArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    FindManyTripsArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    FindUniqueTripsArgs: ["where"],
    FindUniqueTripsOrThrowArgs: ["where"],
